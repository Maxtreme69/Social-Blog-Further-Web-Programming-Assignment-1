...
// NOTE: The posts are not persistant and will be lost when the component unmounts.
            ...
            <form onSubmit={handleSubmit}>
                <fieldset>
                    ...
                    <div className="form-group">
                        <textarea name="post" id="post" className="form-control" row="3"
                    ...
                    posts.length === 0 ?
                        ...
                        posts.map((message) =>
                            <div className="border my-3 p-3" style={{ whiteSpace: "pre-wrap" }}>
                                <h3 className="text-primary">{message.username}</h3>
                                {message.text}
                            </div>
                        )
                }
